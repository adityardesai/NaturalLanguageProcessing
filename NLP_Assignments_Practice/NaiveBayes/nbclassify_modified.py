...
class NaiveClassification:
    ...
    def readModel(self):
        with open("nbmodel_modified.txt") as data_file:    
    ...
    def readDevData(self):
        hCount = 0
        sCount = 0
        with io.open("nboutput_modified.txt", "w", encoding='utf-8', errors='ignore') as rFile:
    ...
    def printDetails(self):
            ...
            with io.open("nboutput_modified.txt", "r", encoding='utf-8') as rFile:
                for line in rFile:
