...
#
# The following Class is used to Train the given set of training data
#
...
class Training:
    ...
    #
    # The following function reads all the train files and seperates out the Ham and Spam Files in respective Lists
    #
    def readFiles(self):
        for root, dirs, files in os.walk(sys.argv[1], topdown=True):
            for presentFile in files:
                ...
                if("spam" in filePath):
                    ...
                    pass
    #
    # The following function reads the Spam List of Files
    #
    ...
    #
    # The following function reads the Ham List of Files
    #
    ...
    def clearDictionaries(self):
        ...
        ()
    #
    # The following function removes any previous files present in the present directory to make sure they wont overwrite resutls
    #
    def removeFiles(self):
        mFilePath1 = "spam.txt"
        mFilePath2 = "ham.txt"
        mFilePath3 = "nbmodel.txt"
        if (os.path.exists(mFilePath1) and os.path.exists(mFilePath2) and os.path.exists(mFilePath3)):
           ...
           os.remove(mFilePath3)
            ...
            pass
    #
    # The following function writes the nbmodel.txt file to the present directory
    #
    def writeDict(self):
        spamFile = 'spam.txt' 
        hamFile = 'ham.txt'
...
#             text_file.write(s2)
    ...
    #
    # The following function is used to check the varios variables of the script
    #
