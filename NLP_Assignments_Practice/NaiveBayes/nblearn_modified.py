...
class Training:
    ...
    def removeFiles(self):
        mFilePath1 = "spam.txt"
        mFilePath2 = "ham.txt"
        mFilePath3 = "nbmodel_modified.txt"
    ...
    def writeDict(self):
        spamFile = 'spam.txt' 
        hamFile = 'ham.txt'
        modelFile = 'nbmodel_modified.txt'
...
#             text_file.write(s2)
    ...
    def printDetails(self):
        print(self.spamFileList)
        print(self.hamFileList)
        print(self.spamVocabulary)
        print(self.hamVocabulary)
        print(self.spamSet)
        print(self.hamSet)
        print(self.totalVoc)
